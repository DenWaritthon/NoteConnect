...
CREATE TABLE note_relation (
  ...
  note_1_id UUID NOT NULL REFERENCES note(note_id) ON DELETE CASCADE,
  note_2_id UUID NOT NULL REFERENCES note(note_id) ON DELETE CASCADE,
...
CREATE TABLE note_relation_evidence (
  evidence_id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  relation_id UUID NOT NULL REFERENCES note_relation(relation_id) ON DELETE CASCADE,
